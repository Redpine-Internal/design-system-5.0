...
- **Components:** React Spectrum (React Aria + React Stately architecture)
- **A11y:** React Aria — most comprehensive accessible component hooks library
- **Governance:** Centralized Adobe team, React Aria is open-source
- **Tooling:** React Aria (hooks-only, unstyled), React Spectrum (styled)
...
| **A11y strategy** | Palette contrast | Built-in ARIA + Tabster | IBM Equal Access | React Aria hooks |
...
| Custom-styled accessible components | Spectrum (React Aria) |
| Cross-platform native feel | Fluent 2 |
| Design token best practices | Carbon (granularity) |
| Accessible hooks without styling | Spectrum (React Aria) |
